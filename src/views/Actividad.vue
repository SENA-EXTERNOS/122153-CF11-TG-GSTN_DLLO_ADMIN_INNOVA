  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido
        .titulo-principal__numero
          span 
            figure
              img(src="@/assets/curso/temas/actividad/actividad-logo.png", alt="Texto que describa la imagen")        
        ...
        .col-12.col-md-8.col-lg-9     
          ...
          .tarjeta.actividad.p-3
            .row.justify-content-around.align-items-center            
              ...
              .col-auto
                a.boton.boton--b.texto-blanco(:href="obtenerLink('/actividades/Actividad_1/index.html')" target="_blank")
                  span Realizar
